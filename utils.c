...
void printHelp() {
    printf("OVERVIEW: A very simple C uncompressed 24-bit/32-bit BMP image editor\n\n"
           ...
           "OPTIONS:\n"
           "   -c <range>      Crop the image\n"
           "   -r <angle>      Rotate the image\n"
           "   -x              Reflect the image horizontally\n"
           "   -y              Reflect the image vertically\n"
           "   -b <radius>     Apply a box blur to the image\n"
           "   -g              Convert the image to grayscale\n"
           "   -l              Apply the Sobel operator to the image\n"
